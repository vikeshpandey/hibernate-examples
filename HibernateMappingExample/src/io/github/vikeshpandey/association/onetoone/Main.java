package io.github.vikeshpandey.association.onetoone;
...
class Main {
	public static void main(String[] args) {
		StandardServiceRegistry ssr = new StandardServiceRegistryBuilder().configure("onetoone/hibernate.cfg.xml")
				.build();
